...
var BufferCacheItem = function (_CacheItem) {
  _inherits(BufferCacheItem, _CacheItem);

  function BufferCacheItem(start, buffer) {
  ...
  _createClass(BufferCacheItem, [{
    ...
    value: function readBytes(dest, start, end) {
      ...
      var sourceBytes = new Uint8Array(this.buffer, readHead, end - start);
