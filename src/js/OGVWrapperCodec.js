	...
	process(callback) {
		...
		if (this.demuxer.loadedMetadata && !this.loadedDemuxerMetadata) {
			...
			if (this.audioDecoder.loadedMetadata) {
				...
				this.loadedAllMetadata = this.loadedAudioMetadata && this.loadedVideoMetadata;
				// console.log('====> SUMAN meta data loaded audio ', this.loadedAudioMetadata);
				finish(true);
			...
			if (this.videoDecoder.loadedMetadata) {
				...
				this.loadedAllMetadata = this.loadedAudioMetadata && this.loadedVideoMetadata;
				// console.log('====> SUMAN meta data loaded video ', this.loadedVideoMetadata);
				finish(true);
			...
			// console.log('====> SUMAN meta data loaded all ', this.loadedMetadata);
			finish(true);
